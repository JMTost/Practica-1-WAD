...
public class VerCategoria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Datos del id: " + request.getParameter("id") + "</h1>");
            ...
            if (dto != null) {
                ...
                out.println("<div class='fw-bold'>Clave:</div>");
                out.println("" + dto.getEntidad().getIdCategoria());
                out.println("</div>");
                out.println("</li>");
                out.println("<li class='list-group-item d-flex justify-content-between align-items-start'>");
                out.println("<div class='ms-2 me-auto'>");
                out.println("<div class='fw-bold'>Nombre:</div>");
                out.println("" + dto.getEntidad().getNombreCategoria());
                out.println("</div>");
                out.println("</li>");
                out.println("<li class='list-group-item d-flex justify-content-between align-items-start'>");
                out.println("<div class='ms-2 me-auto'>");
                out.println("<div class='fw-bold'>Descripción:</div>");
                out.println("" + dto.getEntidad().getDescripcionCategoria());
                out.println("</div>");
                out.println("</li>");
                out.println("</ol>");
                /*out.println("<dl>");
                out.println("<dt> <b>Clave:</b> </dt>");
                out.println("<dd>"+dto.getEntidad().getIdCategoria()+"</dd>");
                out.println("</dl>");
                out.println("<dl>");
                out.println("<dt> <b>Nombre:</b> </dt>");
                out.println("<dd>"+dto.getEntidad().getNombreCategoria()+"</dd>");
                out.println("</dl>");
                out.println("<dl>");
                out.println("<dt> <b>Descripción:</b> </dt>");
                out.println("<dd>"+dto.getEntidad().getDescripcionCategoria()+"</dd>");
                out.println("</dl>");*/
                //out.println(dto);
            }
            out.println("<br/><br/>");
            out.println("<a href='MostrarDatosCategoria' class='btn btn-info' title='Regresar a lista de categorías'>Regresar </a>");
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
        }
